...
namespace SNKRS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Setting(ApplicationUser model, HttpPostedFileBase ProfileImage)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    // Cập nhật tên, số điện thoại và địa chỉ
                    user.Name = model.Name;
                    user.PhoneNumber = model.PhoneNumber;
                    user.Address = model.Address;

                    // Nếu người dùng có tải lên ảnh, lưu nó vào thư mục
                    if (ProfileImage != null && ProfileImage.ContentLength > 0)
                    {
                        // Đặt tên cho ảnh để tránh trùng lặp
                        ...
                        user.ProfileImage = "/Content/Images/" + fileName;
                    }
            ...
            return View(model); // Nếu có lỗi, trả lại view với model cũ
        }
